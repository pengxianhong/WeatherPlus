...
/** 
 * DAO for table "HOT_CITY_INFO_BEAN".
*/
public class HotCityInfoBeanDao extends AbstractDao<HotCityInfoBean, Long> {

    public static final String TABLENAME = "HOT_CITY_INFO_BEAN";

    /**
     * Properties of entity HotCityInfoBean.<br/>
    ...
    public HotCityInfoBeanDao(DaoConfig config) {
        super(config);
    }
    
    public HotCityInfoBeanDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"HOT_CITY_INFO_BEAN\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"HOT_CITY_INFO_BEAN\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, HotCityInfoBean entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, HotCityInfoBean entity) {
        stmt.clearBindings();
    ...
    @Override
    public HotCityInfoBean readEntity(Cursor cursor, int offset) {
        HotCityInfoBean entity = new HotCityInfoBean( //
    ...
    @Override
    public void readEntity(Cursor cursor, HotCityInfoBean entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(HotCityInfoBean entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(HotCityInfoBean entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(HotCityInfoBean entity) {
